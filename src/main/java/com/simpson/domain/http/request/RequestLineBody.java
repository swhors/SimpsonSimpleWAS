...
public class RequestLineBody {
    private static final Logger logger = LoggerFactory.getLogger(RequestLineBody.class);
    ...
    public RequestLineBody(String bodyData) {
        datas = new HashedMap<>();
    ...
    public String getData(String name) {
        ...
        throw new NotFoundParamException("Can't find " + name + ".");
    }
    ...
    public boolean equals(Object o) {
        ...
        RequestLineBody that = (RequestLineBody) o;
